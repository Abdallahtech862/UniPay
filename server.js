...
<style>
  ...
  .unipay-nav-links a { color: #6B4423; text-decoration: none; margin-left: 25px; font-weight: 500; cursor: pointer; }
  .unipay-nav-links a:hover { color: #9C7E5C; }
  .unipay-btn { background: #E8D19A; color: #6B4423; padding: 16px 32px; border-radius: 12px; font-weight: 600; text-decoration: none; display: inline-block; transition: all 0.3s ease; border: none; cursor: pointer; }
  ...
  .unipay-hero { padding: 100px 0 80px; text-align: center; }
  .unipay-hero h1 { font-size: 48px; font-weight: 700; margin-bottom: 20px; line-height: 1.2; }
  .unipay-hero p { font-size: 18px; color: #9C7E5C; margin-bottom: 40px; max-width: 600px; margin-left: auto; margin-right: auto; }
  .unipay-phone { background: #E8D19A; width: 300px; height: 600px; border-radius: 40px; margin: 60px auto 0; padding: 15px; box-shadow: 0 30px 80px rgba(107, 68, 35, 0.2); }
  .unipay-phone-screen { background: #FDF8EF; width: 100%; height: 100%; border-radius: 30px; overflow: hidden; }
  .unipay-header { padding: 20px 20px 10px; display: flex; justify-content: space-between; align-items: center; }
  .unipay-logo { font-size: 18px; font-weight: 700; color: #6B4423; }
  .unipay-settings { width: 28px; height: 28px; background: #E8D19A; border-radius: 8px; }
  .unipay-solde-box { padding: 10px 20px 20px; }
  .unipay-solde-label { font-size: 12px; color: #9C7E5C; margin-bottom: 4px; }
  .unipay-solde { font-size: 32px; font-weight: 700; color: #6B4423; }
  .unipay-qr-section { background: #FFFFFF; margin: 0 20px 20px; padding: 20px; border-radius: 16px; text-align: center; }
  .unipay-qr-box img { width: 120px; height: 120px; display: block; margin: 0 auto; }
  .unipay-actions { padding: 0 20px; display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin-bottom: 20px; }
  .unipay-action-btn { background: #E8D19A; padding: 14px 8px; border-radius: 12px; text-align: center; font-size: 13px; font-weight: 600; color: #6B4423; }
  .unipay-action-btn.secondary { background: #DDE5D9; }
  .unipay-action-btn.outline { background: transparent; border: 1.5px solid #6B4423; }
  .unipay-section-title { font-size: 16px; font-weight: 600; padding: 0 20px; margin: 20px 0 12px; color: #6B4423; }
  .unipay-carte { background: #E8D19A; margin: 0 20px 12px; padding: 16px; border-radius: 12px; }
  .unipay-carte-type { font-size: 11px; color: #6B4423; opacity: 0.7; margin-bottom: 8px; }
  .unipay-carte-numero { font-size: 14px; font-weight: 600; color: #6B4423; letter-spacing: 2px; margin-bottom: 8px; }
  .unipay-carte-solde { font-size: 16px; font-weight: 700; color: #6B4423; }
  .unipay-wallet-section { padding: 80px 0; background: #FFFFFF; }
  .unipay-wallet-box { background: #DDE5D9; border-radius: 24px; padding: 60px 40px; text-align: center; max-width: 900px; margin: 0 auto; }
  .unipay-wallet-box h2 { font-size: 36px; font-weight: 700; margin-bottom: 20px; }
  .unipay-wallet-box p { font-size: 17px; color: #6B4423; margin-bottom: 40px; max-width: 700px; margin-left: auto; margin-right: auto; }
  .unipay-wallet-icons { display: flex; justify-content: center; gap: 30px; flex-wrap: wrap; margin-top: 40px; }
  .unipay-wallet-item { text-align: center; }
  .unipay-wallet-item-icon { width: 70px; height: 70px; background: #FDF8EF; border-radius: 16px; margin: 0 auto 12px; display: flex; align-items: center; justify-content: center; font-size: 32px; }
  .unipay-features { padding: 80px 0; background: #FDF8EF; }
  .unipay-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 40px; margin-top: 60px; }
  .unipay-feature { text-align: center; padding: 30px; background: #FFFFFF; border-radius: 16px; }
  .unipay-icon { width: 64px; height: 64px; background: #DDE5D9; border-radius: 16px; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center; font-size: 28px; }
  .unipay-feature h3 { font-size: 20px; font-weight: 600; margin-bottom: 12px; }
  .unipay-feature p { color: #9C7E5C; font-size: 15px; }
  .unipay-cta { padding: 80px 0; text-align: center; background: #6B4423; color: #FDF8EF; }
  .unipay-cta h2 { font-size: 36px; margin-bottom: 20px; }
  .unipay-cta .unipay-btn { background: #E8D19A; margin-top: 20px; }
  .unipay-footer { background: #FDF8EF; padding: 60px 0 30px; border-top: 1px solid #E8D19A; }
  .unipay-footer-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 40px; margin-bottom: 40px; }
  .unipay-footer h4 { font-size: 16px; font-weight: 600; margin-bottom: 16px; color: #6B4423; }
  .unipay-footer p, .unipay-footer a { color: #9C7E5C; font-size: 14px; text-decoration: none; display: block; margin-bottom: 8px; cursor: pointer; }
  .unipay-footer a:hover { color: #6B4423; }
  .unipay-copyright { text-align: center; padding-top: 30px; border-top: 1px solid #E8D19A; color: #9C7E5C; font-size: 13px; }
  .legal-page { padding: 80px 0; min-height: 60vh; }
  .legal-page h1 { font-size: 36px; margin-bottom: 30px; color: #6B4423; }
  .legal-page h2 { font-size: 24px; margin: 30px 0 15px; color: #6B4423; }
  .legal-page p, .legal-page li { color: #9C7E5C; margin-bottom: 15px; line-height: 1.8; }
  .legal-page ul { margin-left: 20px; margin-bottom: 20px; }
  @media (max-width: 768px) { .unipay-hero h1 { font-size: 32px; } .unipay-hero p { font-size: 16px; } .unipay-wallet-box { padding: 40px 20px; } .unipay-phone { width: 280px; height: 560px; } .unipay-nav-links { display: none; } }
</style>
</head>
<body>
          ...
          <div class="unipay-phone-screen">
            ...
            <div class="unipay-qr-section">
              <div class="unipay-qr-box">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=unipay://pay?user=22675322321" alt="QR UniPay" loading="lazy">
              </div>
            </div>
