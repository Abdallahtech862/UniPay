  ...
  <div id="cgu" class="page">
    <div class="unipay-container">
      <div class="legal-page">
        ...
        <h2>7. Contact</h2>
        <p>Pour toute question : sawabdoulaye7542@gmail.com ou +226 75 32 23 21</p>
      </div>
    </div>
  </div>
  ...
  <div id="confidentialite" class="page">
    <div class="unipay-container">
      <div class="legal-page">
        ...
        <h2>5. Vos droits</h2>
        <p>Conformément à la loi burkinabé, vous disposez d'un droit d'accès, de rectification et de suppression de vos données. Contactez-nous à sawabdoulaye7542@gmail.com</p>
  ...
  <div id="mentions" class="page">
    <div class="unipay-container">
      <div class="legal-page">
        ...
        Email : sawabdoulaye7542@gmail.com<br>
  ...
  <footer class="unipay-footer">
    <div class="unipay-container">
      <div class="unipay-footer-grid">
        ...
        <div>
          <h4>Contact</h4>
          <p>Email : <a href="mailto:sawabdoulaye7542@gmail.com">sawabdoulaye7542@gmail.com</a></p>
