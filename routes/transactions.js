        ...
        <script>
          ...
          transferForm.onsubmit = async e => {
            ...
            if (body.expediteur === body.destinataire) {
              msg.className = 'error'; msg.innerText = 'Expéditeur et destinataire identiques'; return;
            }
    ...
    res.send(`
      ...
      <head>
        ...
        <style>
         ...
         .actions button { margin: 5px; color: white; border: none; cursor: pointer; border-radius: 4px; }
         .actions button.print { background: #6c757d; }
         .actions button.csv { background: #17a2b8; }
         .actions button.pdf { background: #dc3545; }
          @media print {.filtres,.actions, a { display: none; } body { padding: 0; } }
        </style>
      </head>
      <body>
  ...
  res.send(`
    ...
    <body>
      <div class="container">
        ...
        <a href="/api/clients/admin">← Admin</a> | <a href="/api/transactions">Historique</a> | <a href="/api/transactions/add">Nouveau transfert</a>
...
// API Stats pour dashboard - PROTÉGÉ
